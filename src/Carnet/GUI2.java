...
public class GUI2 {
    ...
    public void initialize(Stage stage) {
        ...
        dateCol.setCellValueFactory(new PropertyValueFactory<PersonEntry, String>("date"));
        
        table.setItems(data);
        table.getColumns().addAll(firstNameCol, lastNameCol, emailCol, telCol, addrCol, dateCol);
        ...
        hbox.getChildren().addAll(table, sep, hb);
